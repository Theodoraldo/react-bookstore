...
**Bookstore Project** Bookstore is application that ensures users to add books, delete and track its progress.
...
- cd my-folder
- git clone https://github.com/Theodoraldo/react-bookstore.git
